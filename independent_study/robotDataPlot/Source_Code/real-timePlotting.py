...
c = win.addPlot(title="Basic Test")
lengthOfPlot = 500
...
def plot_update(): #update the plotting data in real time, the length of the data sequence is 500
    global curveX, curveY, curveZ, forceX, forceY, forceZ, ptr, c, dr, cur_length
    force = dr.tcp_force
    ...
    curveX.setData(forceX)
    curveY.setData(forceY)
    curveZ.setData(forceZ)
